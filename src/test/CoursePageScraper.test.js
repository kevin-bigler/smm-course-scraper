...
const PATH_HTML_FILE = path.resolve('src/resources/test/', 'mock_level.html');
...
describe.skip('CoursePageScraper', () => {
    describe('#scrape()', () => {
        ...
        it.skip('gets correct data from the scraped page', () => {
            const expected = {
        ...
        it('handles error for badly formed HTML', () => {
            const actual = uut.scrape('bad html');
